...
with st.sidebar:
    ...
    n_gpu_layers = st.sidebar.slider('n_gpu_layers', min_value=1, max_value=40, value=40, step=1)
    n_batch = st.sidebar.slider('n_batch', min_value=1024, max_value=2048, value=0.1, step=2)
