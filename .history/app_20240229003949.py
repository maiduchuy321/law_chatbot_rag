...
llm = load_model(llm, n_gpu_layers_option, n_batch_option, temperature_option, max_length_option, top_p_option)

# Function for generating llm response
def generate_llm_response(llm, prompt_input):
    ...
    question = f"{string_dialogue} {prompt_input} Assistant: "}
    #Tao chain
